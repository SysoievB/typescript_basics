...
interface Validatable {
    value: string | number;
    required?: boolean;//? makes value optional
    minLength: number | undefined;//makes value optional as well
    maxLength?: number;
    min?: number;
    max?: number;
}
...
class ProjectInput {
    ...
    private configure() {
        //this.element.addEventListener('submit', this.submitHandler.bind(this));//works without @autobind
