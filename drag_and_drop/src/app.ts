...
class State<T> {
    protected listeners: Listener<T>[] = [];//initializes with an empty array at the start
...
class ProjectState extends State<Project> {
    private projects: Project[] = [];//initializes with an empty array at the start
...
interface Validatable {
    value: string | number;
    required?: boolean;//? means value optional -> boolean | undefined
    minLength?: number;
    maxLength?: number;
    min?: number;
    max?: number;
